...
public class CPConstTest {
	...
	public static void main(String[] args) {
		...
		CPFunction func = CPFunctionFactory.createFunction(Statement.CONSTASSIGN, expr);
		...
		//val.setIsBot(false);
		//val.setIsTop(true);
		ConstantPropagation val2 =(ConstantPropagation) func.apply(val);
